...
bool ReadFileV(string& strData, const char* szFormatPath, ...);
bool WriteFile(const char* szFile, const string& strData);
bool WriteFile(const char* szFile, const char* szData, size_t sLen);
bool WriteFileV(string& strData, const char* szFormatPath, ...);
bool WriteFileV(const char* szData, size_t sLen, const char* szFormatPath, ...);
...
const char* StringFormatV(string& strFormat, const char* szFormatArgs, ...);
...
bool SystemExecV(const char* szFormatCmd, ...);
